...
"""
selete phos with at-least 3 bonds attaching to each O
"""
...
def select_phos_site(pdb_interfaces):
    ...
    for interface in pdb_interfaces:
        ...
        for phos,interacting_residues in phos_interacting_residues.items():
            phos_atoms = [r[0].split('_')[-1].strip() for r in interacting_residues]
            print phos_atoms
            if 'O1P' in phos_atoms and 'O2P' in phos_atoms and 'O3P' in phos_atoms:
